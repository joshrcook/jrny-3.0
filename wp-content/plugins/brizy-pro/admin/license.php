...
class BrizyPro_Admin_License
{
    ...
    function handleSubmit()
    {
        ...
        // validate license
        if ($_REQUEST['brizy-license-submit'] == 'Activate' && ! $validLicense) {
        ...
        $params      = [
            ...
            'brizy-license-submit' => $_REQUEST['brizy-license-submit'],
            'key'                  => $_POST['key'],
        ...
        $url                = $_REQUEST['brizy-license-submit'] == 'Activate' ? BrizyPro_Config::ACTIVATE_LICENSE : BrizyPro_Config::DEACTIVATE_LICENSE;
    ...
    public function renderLicenseTab($content = '', $tab = '')
    {
        ...
        return $this->twig->render('license.html.twig', $context);
    }
